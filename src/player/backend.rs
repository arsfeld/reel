...
pub enum PlaybackBackend {
    ...
    #[cfg(feature = "mpv")]
    Mpv(crate::player::mpv_backend::MpvBackend),
}
...
impl PlaybackBackend {
    ...
    pub(crate) fn subtitles_enabled(&self) -> bool {
        match self {
            ...
            #[cfg(feature = "mpv")]
            Self::Mpv(p) => p.subtitles_enabled(),
        }
    }
    ...
    pub(crate) fn select_subtitle(&self, id: Option<&str>) {
        match self {
            ...
            #[cfg(feature = "mpv")]
            Self::Mpv(p) => p.select_subtitle(id),
        }
    }
    ...
    pub(crate) fn load_external_subtitle(&self, uri: &str) {
        match self {
            ...
            #[cfg(feature = "mpv")]
            Self::Mpv(p) => p.load_external_subtitle(uri),
        }
    }
    ...
    pub(crate) fn buffered_fraction(&self) -> f64 {
        match self {
            ...
            #[cfg(feature = "mpv")]
            Self::Mpv(p) => p.buffered_fraction(),
        }
    }
    ...
    #[cfg(feature = "mpv")]
    pub(crate) fn mpv_handle(&self) -> Option<&libmpv2::Mpv> {
        match self {
            Self::GStreamer(_) => None,
            Self::Mpv(p) => Some(p.mpv_handle()),
        }
    }
}
